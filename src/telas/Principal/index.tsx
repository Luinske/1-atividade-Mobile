...
export default function Principal() {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.textEvento}> ToDo </Text>
      <Text style={styles.textData}>Lista de tarefas</Text>
      ...
      <Text style={styles.textTarefa}> Adicionadas {totalTarefas} - Concluídas {totalTarefasConcluidas} </Text>
